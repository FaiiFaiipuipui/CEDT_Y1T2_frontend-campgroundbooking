...
{/* Third Column */}
            ...
            <input id="file-upload" type="file" className="hidden" onChange={(event) => handleFileUpload(event)}/>
        </label>
                    </Button>
                </div> 
                <div className="flex flex-row mt-10 justify-between ">
                    ...
                    <div className="bg-green-600  py-1 px-8 border-2 rounded-[5vh] text-white font-bold hover:cursor-pointer" onClick={() => handleSubmit()}> {" "}Confirm{" "} </div>
                </div>
</div>
            </div>
