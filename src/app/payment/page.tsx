      ...
      <div className="flex border border-black border-solid w-full h-[60vh] grid grid-cols-3 gap-3 flex mt-10 rounded-2xl">
        ...
        <div className="flex justify-center flex-col pr-[5vw]">
          ...
          <div className="flex flex-row mt-10 justify-between ">
            <div className="border border-green-600 border-solid py-1 px-8 border-2 rounded-[5vh] text-green-700 font-bold hover:cursor-pointer">
              {" "}
              Cancel{" "}
            </div>
            <div
              className="bg-green-600  py-1 px-8 border-2 rounded-[5vh] text-white font-bold hover:cursor-pointer"
