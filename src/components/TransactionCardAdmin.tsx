...
export default function TransactionCardAdmin({status}:{status:string}) {
    ...
    return (
        <div className='w-[100%] h-[100%] min-w-[320px] min-h-[550px]  flex flex-row space-x-[20px]'>
            <div className=" min-w-[320px] min-h-[550px] bg-white rounded-[50px] flex flex-row justify-start border border-2">
                <div className="w-[2/5] min-w-[400px] rounded-l-[50px] flex justify-center items-end" style={{
                    backgroundImage: 'url("/img/test_slip_image.jpg")',
                    backgroundRepeat: 'no-repeat',
                    backgroundPosition: 'center',
                    backgroundSize: 'cover',
                    minHeight: '400px' // Optional: Set a minimum height for the div
                }}></div>
                ...
                <div className='flex flex-col'>
                    <div className="w-[3/5] flex flex-col justify-center items-center p-[50px]">
                        <div className="w-full h-full grid grid-cols-2 justify-center items-start text-left space-y-[10px]">
                            ...
                            <div className='col-span-2 font-semibold text-black text-xl'>User&apos;s Name</div>
                            <div className='col-span-2 font-normal text-black text-xl'>Name</div>
                    ...
                    <div id='tagStatus' className={`w-full py-[20px] rounded-br-[50px] bg-opacity-60 ${value === "PENDING" ? "bg-[#D9D9D9]" : value === "REJECTED" ? "bg-[#FF0000]" : "bg-fern"}`}>
                        <div className="">
                            {
                                value === "PENDING" ? <div className="flex flex-row justify-center items-center space-x-[20px]"><PendingIcon sx={{ fontSize: '50px', color: '#626262' }} /><div className="font-bold text-[40px] text-white drop-shadow-md">Payment Pending</div></div>
                                    : value === "REJECTED" ? <div className="flex flex-row justify-center items-center space-x-[20px]"> <CancelIcon sx={{ fontSize: '50px', color: '#B72323' }} /><div className="font-bold text-[40px] text-white drop-shadow-md">Payment Rejected</div></div>
                                        : <div className="flex flex-row justify-center items-center space-x-[20px]"><CheckCircleIcon sx={{ fontSize: '50px', color: '#29FB57' }} /><div className="font-bold text-[40px] text-white drop-shadow-md">Payment Completed</div></div>
                            }
                        </div>
                    </div>
                </div>
